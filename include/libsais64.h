 ...
 * @return 0 if no error occurred, -1 or -2 otherwise.
 */
LIBSAIS64_API int64_t libsais64_omp(const uint8_t * T, int64_t * SA, int64_t n, int64_t fs, int64_t * freq,
                                    int64_t threads);
#endif
 ...
 * @return 0 if no error occurred, -1 or -2 otherwise.
 */
LIBSAIS64_API int64_t libsais64_bwt_aux(const uint8_t * T, uint8_t * U, int64_t * A, int64_t n, int64_t fs,
                                        int64_t * freq, int64_t r, int64_t * I);
 ...
 * @return The primary index if no error occurred, -1 or -2 otherwise.
 */
LIBSAIS64_API int64_t libsais64_bwt_omp(const uint8_t * T, uint8_t * U, int64_t * A, int64_t n, int64_t fs,
                                        int64_t * freq, int64_t threads);
 ...
 * @return 0 if no error occurred, -1 or -2 otherwise.
 */
LIBSAIS64_API int64_t libsais64_bwt_aux_omp(const uint8_t * T, uint8_t * U, int64_t * A, int64_t n, int64_t fs,
                                            int64_t * freq, int64_t r, int64_t * I, int64_t threads);
#endif
 ...
 * @return 0 if no error occurred, -1 or -2 otherwise.
 */
LIBSAIS64_API int64_t libsais64_unbwt(const uint8_t * T, uint8_t * U, int64_t * A, int64_t n, const int64_t * freq,
                                      int64_t i);
 ...
 * @return 0 if no error occurred, -1 or -2 otherwise.
 */
LIBSAIS64_API int64_t libsais64_unbwt_aux(const uint8_t * T, uint8_t * U, int64_t * A, int64_t n, const int64_t * freq,
                                          int64_t r, const int64_t * I);
 ...
 * @return 0 if no error occurred, -1 or -2 otherwise.
 */
LIBSAIS64_API int64_t libsais64_unbwt_omp(const uint8_t * T, uint8_t * U, int64_t * A, int64_t n, const int64_t * freq,
                                          int64_t i, int64_t threads);
 ...
 * @return 0 if no error occurred, -1 or -2 otherwise.
 */
LIBSAIS64_API int64_t libsais64_unbwt_aux_omp(const uint8_t * T, uint8_t * U, int64_t * A, int64_t n,
                                              const int64_t * freq, int64_t r, const int64_t * I, int64_t threads);
#endif
 ...
 * @return 0 if no error occurred, -1 otherwise.
 */
LIBSAIS64_API int64_t libsais64_plcp_omp(const uint8_t * T, const int64_t * SA, int64_t * PLCP, int64_t n,
                                         int64_t threads);
 ...
 * @return 0 if no error occurred, -1 otherwise.
 */
LIBSAIS64_API int64_t libsais64_lcp_omp(const int64_t * PLCP, const int64_t * SA, int64_t * LCP, int64_t n,
                                        int64_t threads);
#endif
